			...
			<div className="app-wrapper row">
				<div className="details-wrapper column">
					...
					<p className="details-text">
						...
						<br />• An increase in diversity as a result of remote recruitment • Money saved on operational costs and
						salary negotiations What better time to refresh your strategy than on the brink of a whole new world? Dig
