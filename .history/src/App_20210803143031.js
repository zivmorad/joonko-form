...
import { ReactComponent as RectangleOrange } from './assets/Rectangle-orange.svg';
import { ReactComponent as RectanglePurple } from './assets/Rectangle-purple.svg';
import { ReactComponent as RectangleRed } from './assets/Rectangle-red.svg';
...
const App = () => {
	...
	const onClickCheckbox = () => {
		...
		newFormValues.isCheckboxChecked = !newFormValues.isCheckboxChecked;
	...
	const validation = () => {
		const newErrors = {};
		let isValid = true;
		const { email, isCheckboxChecked, phone, fullName, companyName } = formValues;
		...
		if (!isCheckboxChecked) {
			newErrors.isCheckboxChecked = true;
			isValid = false;
		}
		setErrors(newErrors);
		return isValid;
			...
			<div className="app-wrapper row">
				...
				<div className="form-section column">
					<div className="form-card column">
						<RectangleOrange className="rectangle-orange" />
						<RectangleRed className="rectangle-red" />
						<form className="form-wrapper column" onSubmit={onClickSubmit}>
							...
							<div className="checkbox-input-wrapper row">
								<input
									...
									value={formValues.isCheckboxChecked}
									checked={formValues.isCheckboxChecked}
								/>
								<div className={`check-box-text ${errors.isCheckboxChecked ? 'checkboxErr' : ''}`}>
